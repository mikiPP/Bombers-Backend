...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            org.lasencinas.bombersauthentication.Model.Domain.AuthUser.Bomber creds = new ObjectMapper()
                    .readValue(req.getInputStream(), org.lasencinas.bombersauthentication.Model.Domain.AuthUser.Bomber.class);
